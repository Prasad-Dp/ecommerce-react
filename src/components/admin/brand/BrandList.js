...
function BrandList() {
  ...
  const brands = useSelector((state) => state.brands.brands.brands);
    ...
    <div className="mx-auto max-w-screen-lg px-2 py-2 sm:px-8">
      <div className="flex items-center justify-between pb-6">
        <div>
          ...
          <span className="text-xs text-gray-500">List of Brands</span>
        </div>
          ...
          <table className="w-full">
            <thead>
              <tr className="bg-blue-600 text-left text-xs font-semibold uppercase tracking-widest text-white">
                ...
                <th className="px-5 py-3">Produts Count</th>
                ...
                <tr key={index}>
                  ...
                  <td className="border-b border-gray-200 bg-white px-5 py-2 text-sm">
                    <div className="flex items-center">
                      ...
                      <div className="ml-3">
                        <p className="whitespace-no-wrap">{brand?.name}</p>
                      </div>
                    </div>
                  </td>
                  <td className="border-b border-gray-200 bg-white px-5 py-2 text-sm ">
